...
*/
     ...
     void reallocateStacks()
    {
        ...
        {
            List.copyRange(stack, 0, stack = new int[stackLength], 0, old_stack_length);
            List.copyRange(locationStack, 0, locationStack = new int[stackLength], 0, old_stack_length);
            List.copyRange(tempStack, 0, tempStack = new int[stackLength], 0, old_stack_length);
        }
        return;
    }
    ...
    //
     final int getFirstToken(int i) { return getToken(i); }
     ...
     final int getToken(int i)
    {
     ...
     final void setSym1(int i) {}
     final int getSym(int i) { return getLastToken(i); }

     final int getFirstToken() { return starttok; }
     final int getLastToken()  { return lastToken; }
