 ...
 class DeterministicParser extends Stacks
{
    ...
    //
     int tAction(int act, int sym[], int index)
    {
    ...
    //
     final int getCurrentRule()
    {
        if (taking_actions)
            return currentAction;
        throw UnavailableParserInformationException();
    }
     final int getFirstToken()
    {
        if (taking_actions)
            return getToken(1);
        throw UnavailableParserInformationException();
    }
     final int getFirstToken(int i)
    {
        if (taking_actions)
            return getToken(i);
        throw UnavailableParserInformationException();
    }
     final int getLastToken()
    {
        if (taking_actions)
            return lastToken;
        throw UnavailableParserInformationException();
    }
     final int getLastToken(int i)
    {
        if (taking_actions)
                                                                                   ...
                                                                                   NotDeterministicParseTableException
    {
     ...
     DeterministicParser(TokenStream tokStream, ParseTable prs, RuleAction ra) throws BadParseSymFileException,
                                                                                            NotDeterministicParseTableException
    {
        reset(null, tokStream, prs, ra);
    }

     DeterministicParser(Monitor monitor, TokenStream tokStream, ParseTable prs, RuleAction ra) throws BadParseSymFileException,
                                                                                                             NotDeterministicParseTableException
    {
    ...
    //
     Object parseActions() throws BadParseException
    {
        //
